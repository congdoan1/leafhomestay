...
public class Security extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				 ...
				 */
				.authorizeRequests().antMatchers("/login**").permitAll().antMatchers("/employees/add").hasRole("ADMIN")
				.antMatchers("/employees").hasAnyRole("ADMIN", "USER").anyRequest().permitAll().and()
				 ...
				 * login
				 */
				.formLogin().loginPage("/login").loginProcessingUrl("/postlogin").defaultSuccessUrl("/welcome")
